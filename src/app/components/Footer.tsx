    ...
    <div className="relative">
      <div className="w-full absolute -bottom-60 md:-bottom-96 bg-[#2D2B42] z-10 md:pt-0 pt-10 pb-4 md:pb-10 rounded-t-[40px] md:rounded-t-[70px]">
        <div className="flex flex-col space-y-4 p-4 md:p-10">
          ...
          <p className="font-inter text-white font-bold text-base md:text-2xl w-full md:w-3/4 leading-relaxed">
          ...
          <div className="mt-4 space-y-4">
            <p className="text-white font-light text-xs md:text-sm font-inter uppercase md:text-left">
              Foster Toys Foundation is a 501(c)3 tax-exempt
              <br /> nonprofit charity organization TAX ID 39-3621457
            </p>
            <p className="text-white text-xs md:text-sm font-inter uppercase md:text-left">
            ...
            <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
              ...
              <Dialog>
                ...
                <DialogContent className="sm:max-w-[450px] bg-[#F9EFE0] rounded-2xl">
                  <DialogHeader>
                    <DialogTitle className="text-4xl font-bold text-[#2D2B42] font-frank">
                      Contact Us
                    </DialogTitle>
              ...
              <motion.button
                ...
                className="bg-[#2D2B42] px-4 py-3 text-white flex items-center justify-center gap-3 rounded-full transition-all duration-300 w-full md:w-auto"
              >
                <span className="text-sm md:text-base">Agency Login</span>
                <Image
                  src={icon}
                  alt="Icon"
                  width={24}
