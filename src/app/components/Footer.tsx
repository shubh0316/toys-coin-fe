...
const Footer = () => {
  ...
  return (
    <div className="relative mt-20">
      <div className="w-full absolute -bottom-60 md:-bottom-80 lg:-bottom-96 bg-[#2D2B42] z-10 md:pt-0 pt-10 pb-4 md:pb-8 lg:pb-10 rounded-t-[40px] md:rounded-t-[50px] lg:rounded-t-[70px]">
        <div className="flex flex-col space-y-4 md:space-y-5 lg:space-y-4 xl:space-y-6 2xl:space-y-10 sm:p-4 p-4 md:p-8 lg:p-12 xl:p-16 2xl:p-20">
          <div className="w-full max-w-[250px] md:max-w-[350px] lg:max-w-[450px] xl:max-w-[600px] 2xl:max-w-[850px]">
            <Image
              src={footerLogo}
              alt="footerLogo"
          ...
          <p className="font-inter text-white font-bold text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-5xl w-full md:w-3/4 lg:w-2/3 !leading-[1.4]">
        ...
        <div className="p-4 md:p-6 lg:p-4">
          <div className="bg-[#31CDE6] mx-auto md:mt-4 lg:mt-6 h-auto md:h-[75px] lg:h-[85px] xl:h-[90px] 2xl:h-[120px] rounded-3xl md:rounded-[40px] lg:rounded-[50px] flex flex-col md:flex-row items-center justify-between p-4 md:p-5 lg:p-4 md:px-5 lg:px-4 gap-4">
            <div className="flex flex-col md:flex-row gap-3 md:gap-4 lg:gap-4 w-full md:w-auto items-center">
                ...
                <DialogTrigger asChild>
                  ...
                  >
                    ...
                    <Image
                      src={contactButton}
                      alt="Contact Us"
                      className="hidden md:block md:max-w-[180px] lg:max-w-[200px] xl:max-w-[220px] 2xl:max-w-[280px] h-auto"
                    />
                  </motion.button>
                </DialogTrigger>
