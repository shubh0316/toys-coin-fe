    ...
    <div id="volunteer" className="relative min-h-screen w-full">
      ...
      <Container>
        <div className="absolute inset-0 flex items-center justify-center px-4 md:px-0 lg:px-8 xl:px-12">
          <div className="rounded-2xl lg:rounded-3xl xl:rounded-[32px] max-w-4xl lg:max-w-5xl xl:max-w-6xl w-full">
            <h2 className="text-4xl md:text-[130px] lg:text-[150px] xl:text-[170px] text-center font-frank text-[#2D2B42] capitalize">
              Volunteers
            </h2>
            <p className="text-white text-lg leading-8 md:text-2xl lg:text-3xl xl:text-4xl text-center font-inter mt-4 md:mt-10 lg:mt-12 xl:mt-16 px-4 md:px-0 lg:px-8 xl:px-12 lg:leading-relaxed xl:leading-relaxed">
            ...
            <div className="mt-6 md:pb-0 pb-10 md:mt-8 lg:mt-12 xl:mt-16 flex justify-center">
              <div className="w-48 md:w-200 lg:w-[250px] xl:w-[300px]">
                <button 
